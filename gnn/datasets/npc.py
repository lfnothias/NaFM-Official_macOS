...
class NPC(InMemoryDataset):
    ...
    def processed_file_names(self):
        return [f"NPC_{self.dataset_arg}.pt"]
    ...
    def process(self):
        for path, processed_path in zip(self.raw_paths, self.processed_paths):
            ...
            labels = target_data["activity_value"].tolist()
            samples = []
...
if __name__ == "__main__":
    dataset = NPC(root="../../downstream_data/regression")
